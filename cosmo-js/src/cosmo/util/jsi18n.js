if(!dojo._hasResource["cosmo.util.jsi18n"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["cosmo.util.jsi18n"] = true;
/*
