if(!dojo._hasResource["cosmo.service.transport.Atom"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["cosmo.service.transport.Atom"] = true;
