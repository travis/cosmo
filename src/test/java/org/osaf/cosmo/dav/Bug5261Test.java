 ...
 */
public class Bug5261Test extends BaseReportTestCase {
    private static final Log log = LogFactory.getLog(Bug5261Test.class);

    /**
     */
    protected void setUpDavData(Node node) throws Exception {
        Node resourceNode =
            testHelper.addCalendarResourceNode(node, "reports/bugs/5261.ics");
    }

    public void testBug5261() throws Exception {
        Document content = testHelper.loadXml("reports/bugs/5261.xml");
        ...
        assertTrue("dav response href does not end with 5261.ics",
                   msr.getHref().endsWith("5261.ics"));
