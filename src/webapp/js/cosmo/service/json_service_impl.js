...
JAVA_EXCEPTION_MAPPING = {"org.osaf.cosmo.rpc.RPCException":ScoobyServiceRemoteException,
                          "org.osaf.cosmo.rpc.RPCNotAuthenticatedException":NotAuthenticatedException};
...
wrapGetEvents = function(getEventsFunction){
    ...
    var realRangeEnd   = arguments[2];
        ...
        dojo.debug("about to filter. size = " + returnVal.length);
        for (var x = 0; x < returnVal.length; x++){
