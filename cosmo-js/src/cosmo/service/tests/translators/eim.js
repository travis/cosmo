...
dojo.provide("cosmo.service.tests.translators.eim");
...
(function(){
var translator = new cosmo.service.translators.Eim(new cosmo.service.UrlCache());
function getEimRecordset(/*Object*/ props){
    props = props || {};
...
doh.register("cosmo.service.test.translators.eim", [
    function getTicketType(){
        var doc = dojox.data.dom.createDocument("<?xml version='1.0' encoding='UTF-8'?>" +
        ...
        jum.assertEquals("type is read-write", "read-write", translator.getTicketType(ticketEl));
    },
    ...
    function parseRecordSet(){
        ...
        var objectList = translator.translateGetItems(a);
        var o1 = objectList[0];
    ...
    function parseRRuleFreq(){
        ...
        rrule = translator.parseRRule(rule, startDate);
    ...
    function parseRRuleUnsupported(){
        var rule = "FREQ=DAILY;UNTIL=20000131T090000Z;BYMONTH=1";
        var rrule = translator.parseRRule(rule);
        ...
        rrule = translator.parseRRule(rule);
    ...
    function itemToRecordSet(){
        ...
        var recordSet = translator.noteToRecordSet(note);
        ...
        recordSet = translator.noteToRecordSet(note);
