...
dojo.declare("cosmo.service.translators.Eim", null, {
    ...
    propsToEventRecord: function(props){
        with (cosmo.service.eim.constants){
            ...
            if (props.rrule != undefined) fields.rrule = [type.CLOB, this.rruleToICal(props.rrule)];
            if (props.exdates != undefined) fields.exdates = [type.CLOB, this.exdatesToEim(props.exdates)];
