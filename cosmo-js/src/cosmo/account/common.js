if(!dojo._hasResource['cosmo.account.common']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['cosmo.account.common'] = true;
/*
