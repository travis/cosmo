if(!dojo._hasResource["cosmo.service.translators.eim"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["cosmo.service.translators.eim"] = true;
/*
