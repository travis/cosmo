if(!dojo._hasResource["cosmo.datetime"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["cosmo.datetime"] = true;
/*
