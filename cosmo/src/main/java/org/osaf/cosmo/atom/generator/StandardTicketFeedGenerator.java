 ...
 * @see CollectionItem
 */
public class StandardTicketFeedGenerator
    extends BaseItemFeedGenerator
    implements TicketFeedGenerator, AtomConstants {
    private static final Log log =
        LogFactory.getLog(StandardTicketFeedGenerator.class);

    public StandardTicketFeedGenerator(StandardGeneratorFactory factory,
