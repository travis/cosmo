...
public interface JcrConstants {
    ...
    public static final String NN_ICAL_COMPLETED = "icalendar:completed";
    ...
    public static final String NN_ICAL_DUE = "icalendar:due";
    ...
    public static final String NN_ICAL_FREEBUSY = "icalendar:freebusy";
    ...
    public static final String NN_ICAL_PERCENT_COMPLETE = "icalendar:percent-complete";
    ...
    public static final String NN_ICAL_REQUESTSTATUS = "icalendar:requeststatus";
    ...
    public static final String NT_CALDAV_EVENT_RESOURCE = "caldav:eventresource";
    ...
    public static final String NP_DAV_CONTENTLANGUAGE = "dav:contentlanguage";

    public static final String NP_CALDAV_CALENDARDESCRIPTION = "caldav:calendar-description";
    ...
    public static final String NP_ICAL_DATETIMEVALUE = "icalendar:datetimevalue";
    ...
    public static final String NP_ICAL_FBTYPE = "icalendar:fbtype";
    ...
    public static final String NP_ICAL_REQUESTSTATUS = "icalendar:requeststatus";
